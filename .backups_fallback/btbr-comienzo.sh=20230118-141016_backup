...
Ese directorio y sus archivos son territorio exclusivo de root, pero con acl se puede conceder permiso de escritura a archivos concretos: \033[38;5;11m'

set -x
[[ ${ejecutarcomandos} == true ]] && setfacl -m u:${milogin42}:rw /usr/local/share/historylogs/a_persistent_history || awk -v lineno=$LINENO '{ if ( NR == lineno ) print }' $0
